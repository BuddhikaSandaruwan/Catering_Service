...
<div id="login-box">
    ...
    <div class="left">
        ...
        <input id="butCustomerSave" type="button" name="signup_submit" value="Sign me up" />
    </div>

    <div class="right">
        <span class="loginwith">Sign in with<br />social network</span>

        <input type="text" name="CustomerNIC" placeholder="CustomerNIC" />
        <input type="text" name="CustomerName" placeholder="CustomerName" />
        <input type="text" name="Adress" placeholder="Adress" />
        <input type="text" name="TP" placeholder="TP" />
...
<script>
    $('#butCustomerSave').click(function () {
        let cusForm = $('#customerForm').serialize();
        $.ajax({
            url: "../Catering_Service/api/service/CustomerService.php",
            method: "POST",
            async: true,
            data: cusForm
        }).done(function (res) {
